            ...
            <form action="{{route('categories.update')}}" enctype="multipart/form-data" method="post">
                ...
                <div class="mb-4">
                    ...
                    <textarea rows="4" name="description"
                              class="appearance-none border border-gray-200 bg-gray-100 rounded-md py-2 px-3 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full"
                              placeholder="Type here">{{$cat->description}}</textarea>
                </div>

                <div class="md:w-1/4">
                    <img class="mx-auto h-40 object-scale-down" src="{{asset('images/brands/'.$cat->icon)}}" alt="Product name text">
                </div>
                <div class="mb-4">
