        ...
        <article class="bg-white rounded shadow-sm border border-gray-200 p-4 lg:p-6 my-5">
            <form action="{{route('products-store')}}" enctype="multipart/form-data" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="sku" id="sku" class="appearance-none border border-gray-200 bg-gray-100 rounded-md py-2 px-3 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full" placeholder="ip-200" />
                </div>
